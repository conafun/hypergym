...
var DEFAULT_EXERCISES = [
  ...
  { name: "卷腹", group: "核心", minWt: 10, maxWt: 30, step: 5, bw: true },
  { name: "卧推", group: "胸", minWt: 40, maxWt: 90, step: 5 },
  { name: "水平胸推", group: "胸", minWt: 20, maxWt: 90, step: 5 },
  { name: "坐姿肩推", group: "肩", minWt: 20, maxWt: 80, step: 5 },
  { name: "坐姿飞鸟", group: "胸", minWt: 10, maxWt: 80, step: 2 },
  { name: "下斜胸推", group: "胸", minWt: 20, maxWt: 90, step: 5 },
  { name: "哈克深蹲", group: "腿", minWt: 20, maxWt: 90, step: 5 },
  { name: "高位下拉", group: "背", minWt: 20, maxWt: 80, step: 2 },
  { name: "大剪刀", group: "背", minWt: 20, maxWt: 90, step: 5 },
  { name: "高位划船", group: "背", minWt: 20, maxWt: 90, step: 5 },
  { name: "坐姿划船", group: "背", minWt: 20, maxWt: 80, step: 2 },
  { name: "俯身划船", group: "背", minWt: 20, maxWt: 80, step: 5 },
  { name: "杠铃深蹲", group: "腿", minWt: 40, maxWt: 80, step: 5 },
  { name: "倒蹬", group: "腿", minWt: 30, maxWt: 90, step: 5 },
  { name: "髋外展", group: "腿", minWt: 20, maxWt: 80, step: 2 },
  { name: "髋内收", group: "腿", minWt: 20, maxWt: 80, step: 2 },
  { name: "髋伸展", group: "腿", minWt: 20, maxWt: 80, step: 2 },
  { name: "罗马椅", group: "核心", minWt: 10, maxWt: 30, step: 5, bw: true },
  { name: "腿弯曲", group: "腿", minWt: 40, maxWt: 80, step: 5 },
  { name: "轨道划船", group: "背", minWt: 20, maxWt: 80, step: 5},
  { name: "面拉", group: "肩", minWt: 20, maxWt: 60, step: 2 },
  { name: "引体向上", group: "背", minWt: 10, maxWt: 30, step: 5, bw: true },
  { name: "双杠臂屈伸", group: "胸", minWt: 10, maxWt: 60, step: 5, bw: true },
  { name: "实力推", group: "肩", minWt: 20, maxWt: 50, step: 5},
  { name: "火箭推", group: "腿", minWt: 20, maxWt: 60, step: 5},
