...
当前版本：**手机端 v3.1.5**（versionCode 12） / **手环端 v1.0.66**（versionCode 66），底部 5 个页签：**数据 / 肌群 / 日记 / 动作 / 传输**。
...
- **区间切换**：**周 / 月 / 全部**。选「全部」时，下面的数据透视与肌群占比都改用全部历史数据一起分析。
...
手环端为 `miband10pro-trainer`（Vela OS 快应用，`com.hypergym`，versionName **1.0.66**，versionCode 66）。主界面是一个横向滑动容器，**左右滑动切换 5 屏**。
...
| **应用版本** | 手机 3.1.5 / versionCode 12 ｜ 手环 1.0.66 / versionCode 66 | — |
